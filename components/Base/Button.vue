...
const variants: Record<TButtonVariants, string> = {
  primary:
    '!rounded-full transition-300 bg-[#7DBA28] hover:bg-[#a0e53e] text-white flex-center sm:!text-base !text-md 2xl:text-xl font-bold sm:px-2 xl:py-2 shadow-[0_6px_16px_rgba(125,186,40,0.3)] hover:shadow-[0_8px_22px_rgba(125,186,40,0.4)]',
  secondary:
